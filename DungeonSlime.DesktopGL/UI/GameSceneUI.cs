...
public class GameSceneUI : ContainerRuntime
{
    ...
    public GameSceneUI()
    {
        ...
        // Create the texture atlas from the XML content file
        var atlasData = content.Load<TextureAtlasData>("TextureAtlasXML");
        TextureAtlas atlas = TextureAtlas.FromAtlasData(content, atlasData);
